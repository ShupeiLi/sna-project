...
if __name__ == "__main__":
    ...
    rellink_model.main()
    rellink_gcn_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 1, proposed=False, gnn_epoch=50, gnn_lr=0.005, visual=False, lr=0.01, node2vec_epoch=10, embedding_dim=128, walk_length=30, p=2, q=0.5, batch_size=64, model_path="../results/models/rellink_1.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
        rellink_gcn_model.gcn_tuning(one_lr, f"lr: {one_lr}")
    rellink_gcn_model.main()
    rellink_our_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 1, proposed=True, gnn_epoch=50, gnn_lr=0.01, visual=False, lr=0.01, node2vec_epoch=10, embedding_dim=128, walk_length=30, p=2, q=0.5, batch_size=64, model_path="../results/models/rellink_1.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
    ...
    rellink_model.node2vec_save()
    rellink_model.main()
    rellink_gcn_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 3, proposed=False, gnn_epoch=50, gnn_lr=0.001, visual=False, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=10, p=2, q=0.5, batch_size=128, model_path="../results/models/rellink_3.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
        rellink_gcn_model.gcn_tuning(one_lr, f"lr: {one_lr}")
    rellink_gcn_model.main()
    rellink_our_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 3, proposed=True, gnn_epoch=50, gnn_lr=0.001, visual=False, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=10, p=2, q=0.5, batch_size=128, model_path="../results/models/rellink_3.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
        rellink_our_model.gcn_tuning(one_lr, f"lr: {one_lr}")
    rellink_our_model.main()
    ...
    rellink_model.node2vec_save()
    rellink_model.main()
    rellink_gcn_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 4, proposed=False, gnn_epoch=50, gnn_lr=0.001, visual=False, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=10, p=2, q=0.5, batch_size=64, model_path="../results/models/rellink_4.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
        rellink_gcn_model.gcn_tuning(one_lr, f"lr: {one_lr}")
    rellink_gcn_model.main()
    rellink_our_model = LinkPredGCN(train_graph, None, train_data, val_data, test_data, 4, proposed=True, gnn_epoch=50, gnn_lr=0.001, visual=False, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=10, p=2, q=0.5, batch_size=64, model_path="../results/models/rellink_4.pt")
    for one_lr in [0.001, 0.005, 0.01, 0.05, 0.1, 0.3, 0.5]:
        rellink_our_model.gcn_tuning(one_lr, f"lr: {one_lr}")
    rellink_our_model.main()
