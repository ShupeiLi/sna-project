...
#       wordnet_model.tuning(f"wordnet_{oper}")
    wordnet_model = LinkPred(train_graph, node_arr.shape[0], train_data, val_data, test_data, 4, node2vec_epoch=5)
    wordnet_model.tuning(f"wordnet_4")
...
#   wordnet_model.main()
#   wordnet_gcn_model = LinkPredGCN(train_graph, node_arr.shape[0], train_data, val_data, test_data, 1, proposed=False, gnn_epoch=50, gnn_lr=0.5, visual=False, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=20, p=2, q=0.25, batch_size=128, model_path="../results/models/wordnet_1.pt")
...
#   # oper: 4
#   wordnet_model = LinkPred(train_graph, node_arr.shape[0], train_data, val_data, test_data, 4, lr=0.1, node2vec_epoch=10, embedding_dim=128, walk_length=20, p=2, q=0.25, batch_size=128, model_path="../results/models/wordnet_4.pt")
#   wordnet_model.node2vec_save()
